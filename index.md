...
**We are hiring!** [Two PhD positions](Files/PhD-positions.pdf) and [one postdoc position](https://arizona.csod.com/ux/ats/careersite/4/home/requisition/8896?c=arizona) are available from this fall. The PhD positions are not strictly defined but can focus on (1) how optical properties of ice crystals influence the radiative heating from clouds in different regions, (2) the importance of secondary ice processes like crystal shattering upon collision to rainfall intensity from mesoscale storms, or (3) the two-way coupling between mesoscale storm passage and aerosol / air quality in a given region. The postdoc position will be focused on helping me set up our laboratory space here to do benchtop experiments on small-scale ice physics. So if you have interest in nucleation or crystallization, optics, high-performance computing, or computational fluid dynamics, please get in touch!
